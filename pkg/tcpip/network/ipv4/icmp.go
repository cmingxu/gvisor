...
func (e *endpoint) handleICMP(r *stack.Route, pb *buffer.PacketBuffer) {
	...
	case header.ICMPv4Echo:
		...
		if err := r.WritePacket(nil /* gso */, hdr, pbCopy.Data, stack.NetworkHeaderParams{Protocol: header.ICMPv4ProtocolNumber, TTL: r.DefaultTTL(), TOS: stack.DefaultTOS}); err != nil {
